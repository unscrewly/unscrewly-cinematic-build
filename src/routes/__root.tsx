  ...
  head: () => ({
    meta: [
      ...
      { title: "Unscrewly — We UNSCREW the Boring" },
      {
        name: "description",
        content:
          "Automation-first web agency. We build websites, SaaS apps, AI tools, and digital products that actually work — fast.",
      },
      { name: "author", content: "Narain Suresh Chawla" },
      { property: "og:title", content: "Unscrewly — We UNSCREW the Boring" },
      {
        property: "og:description",
        content:
          "Solo-founder web agency building websites, SaaS, AI tools and automations.",
      },
